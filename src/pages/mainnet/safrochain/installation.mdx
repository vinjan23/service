...
```
safrochaind init <MONIKER> --chain-id safro-preprod-1
```
...
sed -i -e "s/^minimum-gas-prices *=.*/minimum-gas-prices = \"0.05usaf\"/" $HOME/.safrochain/config/app.toml
```
...
### Snapshot
<a href="https://vinjan-inc.com/mainnet/safrochain/snapshot" target="_blank">
