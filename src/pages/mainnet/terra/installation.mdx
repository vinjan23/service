...
```
curl -L https://snapshot.vinjan-inc.com/terra/genesis.json > $HOME/.terra/config/genesis.json
```

- Addrbook

```
curl -L https://snapshot.vinjan-inc.com/terra/addrbook.json > $HOME/.terra/config/addrbook.json
```
...
<a href="https://vinjan-inc.com/mainnet/terra/cheat" target="_blank">
