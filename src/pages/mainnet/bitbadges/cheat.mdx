...
Unjail Validator
```
bitbadgeschaind tx slashing unjail --from wallet --chain-id bitbadges-1 --gas-adjustment=1.2 --gas=auto --gas-prices="0.025ubadge"
```
...
Withdraw Rewards
```
bitbadgeschaind tx distribution withdraw-all-rewards --from wallet --chain-id bitbadges-1 --gas-adjustment=1.2 --gas=auto --gas-prices="0.025ubadge"
```
...
```
bitbadgeschaind tx staking redelegate $(bitbadgeschaind keys show wallet --bech val -a) <TO_VALOPER_ADDRESS> 1000000000ubadge --from wallet --chain-id bitbadges-1 --gas-adjustment=1.2 --gas=auto --gas-prices="0.025ubadge"
```

Unbond Token from your validator
```
bitbadgeschaind tx staking unbond $(bitbadgeschaind keys show wallet --bech val -a) 1000000000ubadge --from wallet --chain-id bitbadges-1 --gas-adjustment=1.2 --gas=auto --gas-prices="0.025ubadge"
```

Send Token to another wallet
```
bitbadgeschaind tx bank send wallet <TO_WALLET_ADDRESS> 1000000000ubadge --from wallet --chain-id bitbadges-1 --gas-adjustment=1.2 --gas=auto --gas-prices="0.025ubadge"
```
...
```
bitbadgeschaind tx gov vote 1 yes --from wallet --chain-id bitbadges-1 --gas-adjustment=1.2 --gas=auto --gas-prices="0.025ubadge"
```
