...
Unjail Validator
```
atomoned tx slashing unjail --from wallet --chain-id atomone-1
```
...
Withdraw Rewards
```
atomoned tx distribution withdraw-all-rewards --from wallet --chain-id atomone-1
```

Withdraw Rewards with Comission
```
atomoned tx staking delegate $(atomoned keys show wallet --bech val -a) 1000000uatone --from wallet --chain-id atomone-1
```
...
```
atomoned tx staking redelegate $(atomoned keys show wallet --bech val -a) <TO_VALOPER_ADDRESS> 1000000uatone --from wallet --chain-id atomone-1
```

Unbond Token from your validator
```
atomoned tx staking unbond $(atomoned keys show wallet --bech val -a) 1000000uatone --from wallet --chain-id atomone-1
```

Send Token to another wallet
```
atomoned tx bank send wallet <TO_WALLET_ADDRESS> 1000000uatone --from wallet --chain-id atomone-1
```
...
```
atomoned tx gov vote 2 yes --from wallet --chain-id atomone-1
```
