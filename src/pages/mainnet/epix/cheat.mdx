...
```
epixd tx staking redelegate $(epixd keys show wallet --bech val -a) <TO_VALOPER_ADDRESS> 1000000000000000000aepix --from wallet --chain-id epix_1916-1 --gas-adjustment=1.2 --gas-prices="0.001aepix" --gas=auto
```

Unbond Token from your validator
```
epixd tx staking unbond $(epixd keys show wallet --bech val -a) 1000000000000000000aepix --from wallet --chain-id epix_1916-1 --gas-adjustment=1.2 --gas-prices="0.001aepix" --gas=auto
```
