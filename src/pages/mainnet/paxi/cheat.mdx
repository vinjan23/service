...
Unjail Validator
```
paxid tx slashing unjail --from wallet --chain-id paxi-mainnet --gas-prices=0.05upaxi --gas-adjustment=1.5 --gas=auto
```
...
Withdraw Rewards
```
paxid tx distribution withdraw-all-rewards --from wallet --chain-id paxi-mainnet --gas-prices=0.05upaxi --gas-adjustment=1.5 --gas=auto
```
...
```
paxid staking redelegate $(paxid keys show wallet --bech val -a) <TO_VALOPER_ADDRESS> 1000000upaxie --from wallet --chain-id paxi-mainnet --gas-prices=0.05upaxi --gas-adjustment=1.5 --gas=auto
```

Unbond Token from your validator
```
paxid tx staking unbond $(paxid keys show wallet --bech val -a) 1000000upaxi --from wallet --chain-id paxi-mainnet --gas-prices=0.05upaxi --gas-adjustment=1.5 --gas=auto
```

Send Token to another wallet
```
paxi tx bank send wallet <TO_WALLET_ADDRESS> 1000000upaxi --from wallet --chain-id paxi-mainnet --gas-prices=0.05upaxi --gas-adjustment=1.5 --gas=auto
```
