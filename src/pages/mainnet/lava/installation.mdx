...
```
curl -L https://snapshot.vinjan-inc.com/lava/genesis.json > $HOME/.lava/config/genesis.json
```
...
### Snapshot
<a href="https://vinjan-inc.com/mainnet/lava/snapshot" target="_blank">
...
<a href="https://vinjan-inc.com/mainnet/lava/cheat" target="_blank">
