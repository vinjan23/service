...
```
mantrachaind tx staking redelegate $(mantrachaind keys show wallet --bech val -a) <TO_VALOPER_ADDRESS> 1000000uaum --from wallet --chain-id mantrachain-1 --gas-adjustment 1.4 --gas auto -y
```

Unbond Token from your validator
```
mantrachaind tx staking unbond $(mantrachaind keys show wallet --bech val -a) 1000000uaum --from wallet --chain-id mantrachain-1 --gas-adjustment 1.4 --gas auto -y
```
...
```
mantrachaind tx gov vote 1 yes --from wallet --chain-id mantrachain-1 --gas-adjustment 1.4 --gas auto -y
```
