...
Withdraw Rewards
```
symphonyd tx distribution withdraw-all-rewards --from wallet --chain-id symphony-testnet-2 --fees 800note -y
```
...
```
symphonyd tx staking redelegate $(symphonyd keys show wallet --bech val -a) <TO_VALOPER_ADDRESS> 1000000note --from wallet --chain-id symphony-testnet-2 --fees 800note -y
```

Unbond Token from your validator
```
symphonyd tx staking unbond $(symphonyd keys show wallet --bech val -a) 1000000note --from wallet --chain-id symphony-testnet-2 --fees 800note -y
```
