...
```
curl -L https://snapshot-t.vinjan-inc.com/odiseo/genesis.json > $HOME/.achilles/config/genesis.json
```
- Addrbook
```
...
### Snapshot
<a href="https://vinjan-inc.com/testnet/odiseo/snapshot" target="_blank">
...
<a href="https://vinjan-inc.com/testnet/odiseo/cheat" target="_blank">
