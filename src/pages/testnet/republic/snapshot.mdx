...
<SnapshotInfo endpoint="https://snapshot.vinjan-inc.com/republic/log.json" />

## 📦 Republic Testnet Snapshot

Snapshot is updated every **4 hours**.
